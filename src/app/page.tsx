        ...
        <div className="mb-16">
          ...
          {trendingProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500 mb-4">No products shared yet. Be the first to share!</p>
              {session?.user && (
                <Link
                  href="/products"
          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Share Reviews</h3>
                <p className="mt-5 text-base text-gray-500">
          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Connect with Users</h3>
                <p className="mt-5 text-base text-gray-500">
